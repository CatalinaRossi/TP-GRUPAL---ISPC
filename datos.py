...
class Datos(conexion.BDCon):
    def __init__(self):
        conexion.BDCon.__init__(self)
...
#----------------------------------------------------------------------------------------------
    ...
    def InsertarAlbum(self,album):
                self.sentenciaSQL = "insert into album values (null,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s);"
                ...
                self.Conectar()
                self.Commit(self.sentenciaSQL,self.data)
                self.Desconectar()
                print("Álbum insertado correctamente")

#----------------------------------------------------------------------------------------------

    def ModificarAlbum(self,album,id_album):
        self.id_album = id_album
        self.sentenciaSQL = ("""UPDATE album
                        ...
                        WHERE id_album = """) + "'" + str(self.id_album) + "'"
...
#----------------------------------------------------------------------------------------------
    ...
    def BorrarAlbum(self,id_album): 
        self.id_album = id_album
        self.sentenciaSQL = "DELETE FROM album WHERE id_album = %s"
        self.data = (id_album,)
        self.Conectar()
        self.Commit(self.sentenciaSQL,self.data)
        self.Desconectar()
...
#----------------------------------------------------------------------------------------------
    ...
    def ListarAlbumes(self):
        self.sentenciaSQL = "SELECT cod_album, album.nombre, interprete.nombre, interprete.apellido, genero.nombre, discografica.nombre, precio, cantidad, formato.tipo FROM album, interprete, discografica,formato,genero WHERE album.id_interprete = interprete.id_interprete AND album.id_discografica = discografica.id_discografica AND album.id_formato = formato.id_formato AND album.id_genero = genero.id_genero ORDER By interprete.nombre DESC"
        self.Conectar()
        self.resultados = self.Consulta(self.sentenciaSQL)
        self.Desconectar()
        return self.resultados

    def ListarAlbumesPorID(self): #para uso de administracion
        self.sentenciaSQL = "SELECT id_album, cod_album, album.nombre, interprete.nombre, interprete.apellido, genero.nombre, discografica.nombre, precio, cantidad, formato.tipo FROM album, interprete, discografica,formato,genero WHERE album.id_interprete = interprete.id_interprete AND album.id_discografica = discografica.id_discografica AND album.id_formato = formato.id_formato AND album.id_genero = genero.id_genero ORDER By interprete.nombre asc"
        self.Conectar()
        self.resultados = self.Consulta(self.sentenciaSQL)
        self.Desconectar()
        return self.resultados

    def BuscarUnAlbumPorSuID(self,idAlbum): #para uso de administracion
        self.idAlbum = idAlbum
        self.sentenciaSQL = "SELECT album.id_album, album.cod_album, album.nombre, album.id_interprete, album.id_genero, album.cant_temas, album.id_discografica, album.id_formato, album.fec_lanzamiento, album.precio, album.cantidad, album.caratula FROM album WHERE album.id_album = " + "'" + str(self.idAlbum) + "'" 
        self.Conectar()
        self.resultados = self.Consulta(self.sentenciaSQL)
        self.Desconectar()
        return self.resultados
    ...
    def ListarInterprete(self):
        self.sentenciaSQL = "SELECT * from interprete"
        self.Conectar()
        self.resultados = self.Consulta(self.sentenciaSQL)
        self.Desconectar()
        return self.resultados
    ...
    def ListarTema(self):
        self.sentenciaSQL = "SELECT * from tema"
        self.Conectar()
        self.resultados = self.Consulta(self.sentenciaSQL)
        self.Desconectar()
        return self.resultados
    ...
    def ListarGenero(self):
        self.sentenciaSQL = "SELECT * from genero"
        self.Conectar()
        self.resultados = self.Consulta(self.sentenciaSQL)
        self.Desconectar()
        return self.resultados
    ...
    def ListarDiscografica(self):
        self.sentenciaSQL = "SELECT * from discografica"
        self.Conectar()
        self.resultados = self.Consulta(self.sentenciaSQL)
        self.Desconectar()
        return self.resultados
    ...
    def ListarFormato(self):
        self.sentenciaSQL = "SELECT * from formato"
        self.Conectar()
        self.resultados = self.Consulta(self.sentenciaSQL)
        self.Desconectar()
        return self.resultados
...
#----------------------------------------------------------------------------------------------
    ...
    def BusquedaNombreAlbum(self,nombre):
        self.nombre = nombre
        self.sentenciaSQL = """SELECT album.cod_album, album.nombre, interprete.nombre, interprete.apellido, genero.nombre, discografica.nombre, album.precio, album.cantidad, formato.tipo
                                FROM album
                                JOIN interprete
...
#----------------------------------------------------------------------------------------------
    ...
    def CargarInterprete(self,nombre,apellido,nacionalidad,foto):
        ...
        self.sentenciaSQL = "INSERT INTO interprete VALUES(null,%s,%s,%s,%s)" 
        self.data = (self.nombre,self.apellido,self.nacionalidad,self.foto) 
        self.Conectar()
        self.Commit(self.sentenciaSQL,self.data)
        self.Desconectar()
    ...
    #def InsertarInterprete(self,interprete): # codigo de prueba para Insertar Interprete  
                
     #           self.sentenciaSQL = "insert into album values (null,%s,%s,%s,%s,%s,);"
      #          self.data = interprete.getId_Interprete(),
...
class Album():
    ...
    def __str__(self) -> str:
        return str(self.id_album) +' '+ str(self.cod_album) +' '+ str(self.nombre) +' '+ str(self.id_interprete) +' '+ str(self.id_genero) +' '+ str(self.cant_temas) +' '+ str(self.id_discografica) +' '+ str(self.id_formato) +' '+ str(self.fec_lanzamiento) +' '+ str(self.precio) +' '+ str(self.cantidad) +' '+ str(self.caratula)



#---------------------------------------------------------------------

#Test de Insertar Album:

# nuevoAlbum = Album(0,'TGTG777','Album de Prueba',3,5,10,5,3,'1978-01-01',899.99,3,'') #objeto con los datos
# obj = Datos() #objeto con metodos de carga a la BD 
# obj.InsertarAlbum(nuevoAlbum)

#---------------------------------------------------------------------
#Test de Listados de las tablas:

#obj = Datos()
#obj.ListarDiscografica()
...
#Test de Buscar Album por Nombre:

#obj = Datos()
#obj.BusquedaNombreAlbum("Las Cosas Que Vives")
