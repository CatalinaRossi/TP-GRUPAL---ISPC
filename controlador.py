...
def InsertarAlbum():
    cod_album =int(input("\nIngrese el código del nuevo Album: "))
    nombre = input("Ingrese el nombre del álbum: ")

    con = modelo.Conectar()

    print("nIntérpretes Disponibles: ")

    for i in con.ListarInterprete():
        print(i)
    id_interprete = int(input("\nIngrese el ID del Intérprete")) ##hasta aca esta el codigo video 6 minuto 22.10
   
    print("\nGénero")
    for g in con.ListarPorGenero():
        print(g)
